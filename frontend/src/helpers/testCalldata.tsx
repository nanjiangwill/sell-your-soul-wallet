...
const testCalldata = async (
    signer: any,
        ...
        console.log(result1)
        const result = await OwnershipNFTContract.tokenOfOwnerByIndex("0xc4530619ca5114587671301505a0b8ed41c51580", 0)
        console.log(result)
        ...
        let calldata = iface.encodeFunctionData("transferFrom", ["0xc4530619ca5114587671301505a0b8ed41c51580", "0xdc4ff38744e85c6f6b52032a2cfb32991b46eb6c", BigNumber.from("0x9bcc2344216512091ad26b2cda13ab4d103cf36e")]);
        ...
        console.log(calldata);
        // calldata = iface.encodeFunctionData("exec", [[["0xc4530619ca5114587671301505a0b8ed41c51580", calldata]]]);
        // console.log(calldata);

        // const aaa = await NFTWalletContract.exec([["0xc4530619ca5114587671301505a0b8ed41c51580", calldata]])
        // console.log(aaa)
    ...
    // 0x5c9CB0115DdE2CCD8819E0AC9a01CAFE30Be8Ba8
        // 0x6cba0f45da0fadcfc1146d4c7ef87e952830ff4b
            ...
            // 0xc4530619ca5114587671301505a0b8ed41c51580
                // 0x2b0b46b6e1dbe5b227042e9929846bef6014e523(gone to test account)
        // 0xdc4ff38744e85c6f6b52032a2cfb32991b46eb6c
            // 0x9bcc2344216512091ad26b2cda13ab4d103cf36e
                // 0x89ad864571344898c313c1013c817cc6f2e3b699
        // 0xa1812d0f75db8730598092f26795e10a434169f5
        // 0x5be58e99e845b72f465dd921543c7b3fe42e01f1(TO Jason Done)
